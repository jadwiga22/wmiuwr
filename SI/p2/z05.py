...
# we implement A* algorithm with sum instead of max in the approximate 
# distance function.
...
def solve():
    ...
    with open(FILE_IN) as file:
        with open(FILE_OUT, "w") as file_out:
            ...
            with open("results_nopt_z05.txt") as file_ans:
                line = file_ans.readline()
                
                if line:
                    s = int(line.replace("\n", ""))

            with open("results_nopt_z05.txt", "w") as file_ans:
